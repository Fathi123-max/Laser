...
class UpdateOrderPage extends GetWidget<HomeController> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // PageBanner(
            //     pageIndex: 6,
            //     pageTitle: "Update Order".tr,
            //     pageSubTitle: "Please Choose Date and Hours".tr),
            // const Gap(26),
            Row(
              children: [
                Gap(13.w),
                ...
                AuthButton(
                  onPressed: () {
                    showLoadingOverLay(asyncFunction: () {
                      return controller.rescheduleOrder(
