...
import 'holdwidget/hold_checkbox_widget.dart';

class UpdateHoldDialogScreen extends GetView<TecHomeController> {
  const UpdateHoldDialogScreen({super.key, this.acceptedOrder});
