...
class FinishedOrdersPage extends GetView<TecHomeController> {
        ...
        return NotificationListener(
          onNotification: (ScrollNotification scrollInfo) {
            if (scrollInfo.metrics.pixels ==
              ...
              _debounce = Timer(const Duration(milliseconds: 500), () {
                ...
                currentPageIndex++;
                controller.getFinishedOrders(index: currentPageIndex);
          ...
          child: SizedBox(
            ...
            child: ListView.separated(
              itemCount: controller.finishedOrders.value.length,
